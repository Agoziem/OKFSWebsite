...
from SRMS.models import Class
from TMS.models import Teacher
...
def login_view(request):
    if request.method == 'POST':
        ...
        if user is not None:
            login(request, user)
            return redirect('TMS:Teachers_dashboard')  # Replace 'home' with the name of your desired homepage URL
        else:
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if Role == 'Formteacher':
                ...
                teacher.save()
            return redirect(reverse('TMS:profile', kwargs={'id': teacher.id }))  # Replace 'home' with the name of your desired homepage URL
    context = {
        'classes': classes
    }
