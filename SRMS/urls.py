...
urlpatterns = [
    ...
    path('activation/createseniorAnnualstudents/', createseniorstudentAnnual_view, name='seniorstudentsannual'),
    path('activation/createseniorAnnualresults1/', createseniorresultAnnual1_view, name='seniorresult1annual'),
    path('activation/createseniorAnnualresults2&3/', createseniorresultAnnual2_view, name='seniorresult2annual'),
